      ...
      <form onSubmit={submit} className="mt-6">
        {preview ? (
          ...
          <section className="space-y-8 rounded-3xl border border-brand-950/10 bg-white p-5 shadow-sm sm:p-7">
            ...
            <div className="flex flex-col-reverse gap-2 border-t border-slate-100 pt-6 sm:flex-row"><button type="button" onClick={() => onNavigate('dashboard')} className="min-h-12 flex-1 rounded-full border border-slate-200 text-sm font-black">Cancel</button><button type="submit" className="inline-flex min-h-12 flex-1 items-center justify-center gap-2 rounded-full bg-slate-950 text-sm font-black text-white hover:bg-[#2563eb]"><Eye className="h-4 w-4" />Review job</button></div>
          </section>
        )}
      </form>
    </main>
